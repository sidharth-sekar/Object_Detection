...
assistance_requested = False  # Tracks if assistance has been requested to avoid repetitive announcements
    ...
    while cap.isOpened():
        ...
        if results_pose.pose_landmarks:
            if not landmarks_formed:
                ...
                print("Person detected. Monitoring hand positions...")
            ...
            if ((right_wrist.y < right_shoulder.y) or (left_wrist.y < left_shoulder.y)) and not assistance_requested:
                print("Customer needs assistance")
                speak_async("Customer needs assistance")
                assistance_requested = True  # Avoid repetitive announcements
            elif (right_wrist.y > right_shoulder.y) and (left_wrist.y > left_shoulder.y):
                # Reset assistance request if no hands are raised
